...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='w-full m-5'>
            ...
            <p className='mb-3 text-lg font-medium text-[#7E60BF] '>Add Doctor</p>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full bg-[#7E60BF]'>Add doctor</button>
